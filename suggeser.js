! function(e) {
    ...
    function o(e, t) {
        ...
        i.element = e, i.el = p(e), i.suggestions = [], i.badQueries = [], i.selectedIndex = -1, i.currentValue = i.element.value, i.intervalId = 0, i.cachedResponse = {}, i.onChangeInterval = null, i.onChange = null, i.isLocal = !1, i.suggestionsContainer = null, i.noSuggestionsContainer = null, i.options = p.extend({}, s, t), i.classes = {
            selected: "autocomplete-selected",
            suggestion: "autocomplete-suggestion"
        }, i.hint = null, i.hintValue = "", i.selection = null, i.initialize(), i.setOptions(t)
    }
    var i = {
    ...
    o.utils = i, (p.Autocomplete = o).formatResult = function(e, t) {
        ...
        setOptions: function(e) {
            var t = this,
                n = t.options;
            p.extend(n, e), t.isLocal = p.isArray(n.lookup), t.isLocal && (n.lookup = t.verifySuggestionsFormat(n.lookup)), n.orientation = t.validateOrientation(n.orientation, "bottom"), p(t.suggestionsContainer).css({
        ...
        fixPosition: function() {
            var e, t, n, i, s, o, a, u, r, l, c, g = this,
                d = p(g.suggestionsContainer),
                h = d.parent().get(0);
            h !== document.body && !g.options.forceFixPosition || (r = g.options.orientation, e = d.outerHeight(), t = g.el.outerHeight(), i = {
                top: (n = g.el.offset()).top - 2,
                left: n.left
            }, "auto" === r && (s = p(window).height(), a = -(o = p(window).scrollTop()) + n.top - e, u = o + s - (n.top + t + e), r = Math.max(a, u) === a ? "top" : "bottom"), i.top += "top" === r ? -e : t, h !== document.body && (c = d.css("opacity"), g.visible || d.css("opacity", 0).show(), l = d.offsetParent().offset(), i.top -= l.top, i.left -= l.left, g.visible || d.css("opacity", c).hide()), "auto" === g.options.width && (i.width = g.el.outerWidth() + "px"), d.css(i))
        },
        ...
        getSuggestions: function(i) {
            var e, t, n, s, o = this,
                a = o.options,
                u = a.serviceUrl;
            if (a.params[a.paramName] = i, t = a.ignoreParams ? null : a.params, !1 !== a.onSearchStart.call(o.element, a.params)) {
                ...
                (e = o.isLocal ? o.getSuggestionsLocal(i) : (p.isFunction(u) && (u = u.call(o.element, i)), n = u + "?" + p.param(t || {}), o.cachedResponse[n])) && p.isArray(e.suggestions) ? (o.suggestions = e.suggestions, o.suggest(), a.onSearchComplete.call(o.element, i, e.suggestions)) : o.isBadQuery(i) ? a.onSearchComplete.call(o.element, i, []) : (o.abortAjax(), s = {
                    url: u,
                    data: t,
                    type: a.type,
                    dataType: a.dataType
                }, p.extend(s, a.ajaxSettings), o.currentRequest = p.ajax(s).done(function(e) {
                    var t;
        ...
        hide: function() {
            ...
            p.isFunction(e.options.onHide) && e.visible && e.options.onHide.call(e.element, t), e.visible = !1, e.selectedIndex = -1, clearInterval(e.onChangeInterval), p(e.suggestionsContainer).hide(), e.signalHint(null)
        },
        suggest: function() {
            if (0 !== this.suggestions.length) {
                ...
                }), this.adjustContainerWidth(), l.detach(), r.html(g), p.isFunction(c) && c.call(e.element, r), e.fixPosition(), r.show(), t.autoSelectFirst && (e.selectedIndex = 0, r.scrollTop(0), r.children("." + u).first().addClass(n)), e.visible = !0, void e.findBestHint())
            }
            this.options.showNoSuggestionNotice ? this.noSuggestions() : this.hide()
        },
        noSuggestions: function() {
            var e = p(this.suggestionsContainer),
                t = p(this.noSuggestionsContainer);
...
function() {
    function e() {
        this._busy = !1, this._nextSuggestQuery = null, this._suggesting = !1
    }
    ...
    var o = {
        ...
        content: '<div class="error-info">Request failed</div>'
    };
    ...
    e.prototype = {
        ...
        suggest: function(e, t) {
            var n = this;
            return n._suggesting ? void(n._nextSuggestQuery = {
                query: e,
                callback: t
            }) : (n._suggesting = !0, void $.ajax({
                ...
                n._suggesting = !1, n._nextSuggestQuery && (n.suggest(n._nextSuggestQuery.query, n._nextSuggestQuery.callback), n._nextSuggestQuery = null)
            }))
        },
        ...
        submit: function(e) {
            ...
            s ? i.update({
                ...
                content: $('<div class="error-info"></div>').text(t)[0].outerHTML
            }) : (i.service.stopSuggest(), (n = i.service.find(this.getInputValue(), e, function(e) {
                i.hideSuggestion(), i.update(e), i.setStatus()
            })) && (i.setStatus(!0), "search" === n ? i.$supportedSitesList.hide() : i.$supportedSitesList.show()))
        },
